...
Nova.booting(function (Vue, router, store) {
  ...
  }]), Vue.component('table-component', __webpack_require__(14));
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    actions: {
        fetchAddresses: function fetchAddresses(context) {
            ...
            var x = '[{"class":"App\\\\Nova\\\\Filters\\\\IsOld","value":{"isOld":"' + context.state.isOld + '","id":' + context.state.user_id + '}}]';
            var encoded_filter = btoa(x);
            console.log(encoded_filter);
            Nova.request('http://localhost:1234/nova-api/addresses?search=' + context.state.pattern + '&filters=' + encoded_filter + '&orderBy=&perPage=25&trashed=&page=1&relationshipType=').then(function (result) {
                var data = result.data.resources; //array of objects {attribute,value}
                var temp_arr = [];
                data.forEach(function (element) {
                    var fields = element['fields']; //arr
                    var temp_obj = {};
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["c" /* mapMutations */])(['idUpdate', 'patternUpdate', 'isOldUpdate']), Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["a" /* mapActions */])(['fetchAddresses']), {
        ...
        ss: function ss() {
            var x = window.btoa('[{"class":"App\\Nova\\Filters\\IsOld","value":{"isOld":"1","id":"2"}}]', 'base64');
            console.log(x);
        }
    }),
    computed: _extends({}, Object(__WEBPACK_IMPORTED_MODULE_0_vuex__["b" /* mapGetters */])(['getId', 'getUserAddresses']))
});
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "row" }, [
        ...
        _vm._v(" "),
        _c("button", { on: { click: _vm.ss } }, [_vm._v("get")])
      ])
    ],
    1
  )
